...
public class GatewayConfig {
    ...
    @PostConstruct
    public void doInit() {
        initCustomizedHandler();
        initCustomizedApis();
        initGatewayRules();
    }

    private void initCustomizedHandler() {
        BlockRequestHandler blockHandler = new DefaultBlockRequestHandler();
    ...
    private void initGatewayRules() {
        ...
        // 通过route_id限流
        rules.add(new GatewayFlowRule("test_flow_rule")
